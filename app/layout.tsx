...
export const metadata: Metadata = {
  title: 'Funki Monki - Premium Home Furnishings',
  description: 'Discover fun and funky home furnishings that bring life to your space',
};
          ...
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
            <div className="w-full py-6 flex items-center justify-between border-b border-gray-200">
              <div className="flex items-center space-x-2">
                ...
                />
                <span className="text-2xl font-bold text-gray-900">Funki Monki</span>
              </div>
              <div className="hidden md:flex space-x-8">
                <a href="/" className="text-base font-medium text-gray-700 hover:text-gray-900">Home</a>
                <a href="/products" className="text-base font-medium text-gray-700 hover:text-gray-900">Products</a>
                <a href="/about" className="text-base font-medium text-gray-700 hover:text-gray-900">About</a>
        ...
        <footer className="bg-gray-800 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-4">Luxe Haven</h3>
                <p className="text-gray-300">Elevating homes with premium furnishings and timeless designs since 2020.</p>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="text-gray-300 hover:text-white">Outdoor</a></li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="mt-6">
                  <h5 className="text-sm font-semibold uppercase tracking-wider mb-2">Newsletter</h5>
                  <div className="flex">
                    <input type="email" placeholder="Your email" className="px-4 py-2 w-full rounded-l-md text-gray-900" />
            ...
            <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
              <p className="text-base text-gray-400">&copy; 2025 Luxe Haven. All rights reserved.</p>
              <div className="mt-4 flex space-x-6 md:mt-0">
                ...
                <a href="#" className="text-gray-400 hover:text-gray-300">Sitemap</a>
              </div>
            </div>
          </div>
        </footer>
